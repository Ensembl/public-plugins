package EnsEMBL::Admin::Rose::Manager::ProductionSpecies;

### NAME: EnsEMBL::Admin::Rose::Manager::ProductionSpecies
### Module to handle multiple ProductionSpecies entries 

### N.B. Not to be confused with Ensembl::Admin::Rose::Manager::Species - 
...
sub object_class { 'EnsEMBL::Admin::Rose::Object::ProductionSpecies' }
