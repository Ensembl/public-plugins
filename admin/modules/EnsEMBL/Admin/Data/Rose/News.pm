package EnsEMBL::Admin::Data::Rose::News;

### NAME: EnsEMBL::Admin::Data::Rose::News;
### Wrapper for one or more EnsEMBL::Admin::Rose::Object::NewsItem objects
...
use EnsEMBL::Admin::Rose::Manager::NewsItem;
use base qw(EnsEMBL::ORM::Data::Rose);

sub set_classes {
### Set custom class names, as they are not quite the same as the URL
  my $self = shift;
  $self->{'_object_class'} = 'EnsEMBL::Admin::Rose::Object::NewsItem';
  $self->{'_manager_class'} = 'EnsEMBL::Admin::Rose::Manager::NewsItem';
}
