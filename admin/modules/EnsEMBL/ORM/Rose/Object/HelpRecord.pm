...
__PACKAGE__->meta->setup(
  ...
  columns     => [
    ...
    keyword        => {type => 'text'},
    data           => {type => 'datamap',                   not_null => 1, 'keys' => [qw(question answer category word expanded meaning list_position length youtube_id title ensembl_object ensembl_action content)]},
