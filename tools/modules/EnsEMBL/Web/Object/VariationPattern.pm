...
package EnsEMBL::Web::Object::VariationPattern;
...
sub species_list {
  ...
  if (!$self->{'_species_list'}) {
    ...
    for ($self->valid_species) {
      next if $_ ne "Homo_sapiens"; #restricting species list to human only for allele frequency, remove this if you want full list of species
...
### Uses Controller::Download, via url /Download/VariationPattern/
