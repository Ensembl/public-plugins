...
package EnsEMBL::Web::Component::Tools::VEP::AFDB;
...
# use base qw(EnsEMBL::Web::Component::Variation EnsEMBL::Web::Component::Variation::AFDB);
...
sub content {
  my $html = "<h1>I am AFDB in tools</h1>";
