...
sub content {
  ...
  foreach my $section(@sections) {
    ...
    $fieldset->set_attributes({ id => 'vep'.$section->{id}, 'class' => ['config', 'toggleable', $show ? () : 'hidden'], 'style' => 'margin-top: 10px'});
...
sub _build_input {
  ...
  my %example = (
    'ensembl' =>  qq(1  160283  471362   DUP
1  881907  881906  -/C  +
5  140532  140532  T/C  +),
