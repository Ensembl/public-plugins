...
package EnsEMBL::Web::Ticket::VcftoPed;
...
sub init_from_user_input {
  ...
  $self->add_job(EnsEMBL::Web::Job::VcftoPed->new($self, {
    'job_desc'    => $hub->param('name') ? $hub->param('name') : $hub->param('collection_format') eq 'custom' ? "VCF to PED (Custom file)" : "VCF to PED (".$hub->param('collection_format').")",
    'species'     => $species,
