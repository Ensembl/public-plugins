...
package EnsEMBL::Web::Ticket::Forger;
...
sub init_from_user_input {
  ...
  $self->add_job(EnsEMBL::Web::Job::Forger->new($self, {
    'job_desc'    => $hub->param('name') ? $hub->param('name') : $hub->param('collection_format') eq 'custom' ? "Forger (Custom file)" : "Forger (".$hub->param('collection_format').")",
    'species'     => $species,
