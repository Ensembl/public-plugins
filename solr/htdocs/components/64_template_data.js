...
(function() {
  ...
  window.google_templates = {
    ...
    sizer: {
      template: "<div><div class='g_sizer'></div></div>",
      subtemplates: {
        '.g_sizer': {
          template: 'feet',
          data: 'sel'
      ...
      preproc: function(spec, pre) {
        var entries, x, _i, _len, _ref;
        entries = [];
        _ref = pre.sizes;
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          x = _ref[_i];
      ...
      postproc: function(el, data) {
        return data.set_fn = data.sel.set_fn;
      }
    },
    download: {
      template: "<div></div>"
