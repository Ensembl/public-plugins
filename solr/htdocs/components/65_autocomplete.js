...
(function() {
  var ac_name_a, ac_name_q, ac_string_a, ac_string_q, ajax_json, boost, direct_format, direct_link, direct_order, direct_searches, favourite_species, favs, internal_site, jump_searches, jump_to, rate_limit, score_of, sections, sort_docs, sp_fav, sp_map, sp_names, _score;
  ...
  ac_name_a = function(input, output) {
    var d, doc, docs, i, p, parts, s, species, ucspecies, _i, _len, _ref, _ref1, _ref2, _results;
    ...
    for (i = _i = 0, _len = _ref2.length; _i < _len; i = ++_i) {
      ...
      _results.push((function() {
        ...
        for (_j = 0, _len1 = docs.length; _j < _len1; _j++) {
          ...
          _results1.push(output.push(doc));
        }
        return _results1;
      })());
    }
