...
(function() {
  var ac_name_a, ac_name_q, ac_string_a, ac_string_q, ajax_json, boost, direct_format, direct_limit, direct_link, direct_order, direct_searches, favourite_species, favs, gi_direct, internal_site, jump_searches, jump_to, load_config, make_rate_limiter, rate_limit, score_of, sections, sort_docs, sp_fav, sp_map, sp_names, _score;
  ...
  ac_name_q = function(config, url, query, favs) {
    var _this = this;
    return load_config().then(function(x) {
