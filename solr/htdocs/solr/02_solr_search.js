...
(function() {
  ...
  body_elevate_quoted = function() {
    return {
      ...
      prepare: function(context, input, tags_in, depart, arrive) {
        var input_quoted, input_unquoted, tags_quoted;
        if (!tags_in.main) {
          return null;
        }
        ...
        return [[input_quoted, tags_quoted, depart, arrive], [input_unquoted, tags_in, depart, arrive]];
      }
    };
  };
    ...
    raw_request = function(input, request, start, len) {
      ...
      if (start === -1) {
        ...
        return request.raw_ajax(params).then(function(data) {
          var _ref, _ref1;
          return [data, (_ref = data.result) != null ? (_ref1 = _ref.response) != null ? _ref1.numFound : void 0 : void 0];
        });
      } else {
        params.rows = len;
        params.start = start;
