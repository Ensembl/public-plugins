...
(function() {
  ...
  should_exclude_from_quicklinks = function(title, doc) {
    var l, len1, name, ref, rule, rules, score;
    ...
    for (l = 0, len1 = rules.length; l < len1; l++) {
      ...
      ref = rule.split(':'), name = ref[0], score = ref[1];
      if (name === title.toLowerCase() && score === '0') {
        return true;
      }
    }
    return false;
