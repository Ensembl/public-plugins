...
(function() {
  var Hub, Renderer, Request, RequestDispatch, SearchTableState, Source, code_select, ddg_codes, double_trap, obj_to_str, remote_log, ucfirst, xhr_idx, _a, _ajax_json, _clone_array, _clone_object, _div, _is_prefix_of, _kv_copy, _span,
  ...
  Request = (function() {
    ...
    function Request(hub, source, renderer) {
      ...
      this.source = source;
      this.renderer = renderer;
      this.rate_limiter = new window.EphemoralRequestRateLimiter(1000, 2000, (function(v) {
    ...
    Request.prototype.relevant_data = function(filter, cols, order, start, rows) {
      ...
      b = _clone_object(this.rate_limiter.get());
