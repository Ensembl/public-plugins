  ...
  dispatch_main_requests = function(request, state, table, query, update_seq) {
    ...
    return ret.then(function(sizes) {
      ...
      results = results.then(function(docs_frags) {
        return each_block(inspects.length, function(i) {
          if (inspects[i] != null) {
            return inspects[i](contexts[i], requests, docs_frags);
          }
        }).then(function() {
          return docs_frags;
        });
