...
(function() {
  var Hub, Renderer, Request, SearchTableState, Source, code_select, dispatch_all_requests, dispatch_facet_request, dispatch_main_requests, double_trap, each_block, generate_block_list, main_currency, rate_limiter, remote_log, xhr_idx, _clone_array, _clone_object, _kv_copy,
  ...
  Source = (function(_super) {
    ...
    Source.prototype.get = function(filter, cols, order, start, rows, force) {
      return this.req.get(filter, cols, order, start, rows, force);
    };
