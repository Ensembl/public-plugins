...
(function() {
  var Hub, Renderer, Request, SearchTableState, add_extra_constraints, all_requests, body_elevate_quoted, body_embeded_species, body_frontpage_specials, body_highlights, body_raw_request, body_requests, body_split_favs, code_select, current_update_seq, dispatch_all_requests, dispatch_facet_request, dispatch_main_requests, double_trap, each_block, generate_block_list, rate_limiter, remote_log, run_all_prepares, xhr_idx, _clone_array, _clone_object, _kv_copy,
    __slice = [].slice,
  ...
  body_requests = [body_raw_request, body_embeded_species, body_frontpage_specials, body_highlights, body_elevate_quoted, body_split_favs];
