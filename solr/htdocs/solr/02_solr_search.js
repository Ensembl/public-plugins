...
(function() {
  var Hub, Renderer, Request, SearchTableState, add_extra_constraints, all_requests, body_elevate_quoted, body_frontpage_specials, body_highlights, body_raw_request, body_requests, body_species_homepage_request, body_split_favs, build_blocks, code_select, current_update_seq, dispatch_all_requests, dispatch_facet_request, dispatch_main_requests, double_trap, each_block, generate_block_list, rate_limiter, remote_log, run_all_prepares, xhr_idx, _clone_array, _clone_object, _kv_copy,
    __slice = [].slice,
    _this = this,
  ...
  add_extra_constraints = function(q_in, fq_in, extra) {
    var boost, bq, field, fq, i, invert, q, s, str, v, values, x, _i, _j, _len, _len1, _ref;
    q = [q_in];
    fq = fq_in.slice(0);
  ...
  body_raw_request = function() {
    ...
    raw_request = function(input, request, context, start, len) {
      ...
      if (start === -1) {
        params.start = 0;
        params.rows = 10;
        return request.request_results(params).then(function(data) {
          return data.num;
        });
      } else {
        params.rows = len;
  ...
  body_split_favs = function() {
    ...
    prepare = function(context, input_in, tags_in, depart, arrive) {
      var fq, input, k, order, out, q, tags, v, x, _i, _len, _ref;
  ...
  body_requests = [body_raw_request, body_species_homepage_request, body_frontpage_specials, body_highlights, body_elevate_quoted, body_split_favs];

  run_all_prepares = function(contexts, plugins, input) {
    var i, output, p, query, tags_in, v, _i, _j, _len, _len1;
    tags_in = {
      main: 1
    };
  ...
  build_blocks = function(inputs) {
    var input, out, _fn, _i, _len;
    out = [];
    _fn = function(ii) {
      var _this = this;
  ...
  Request = (function() {
    ...
    Request.prototype.request_results = function(params) {
      var _this = this;
      return this.raw_ajax(params).then(function(data) {
        var doc, docs, h, num, snippet, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
        num = (_ref = data.result) != null ? (_ref1 = _ref.response) != null ? _ref1.numFound : void 0 : void 0;
        docs = (_ref2 = data.result) != null ? (_ref3 = _ref2.response) != null ? _ref3.docs : void 0 : void 0;
        for (_i = 0, _len = docs.length; _i < _len; _i++) {
          doc = docs[_i];
          snippet = (_ref4 = data.result) != null ? (_ref5 = _ref4.highlighting) != null ? _ref5[doc.uid] : void 0 : void 0;
          if (snippet != null) {
            _ref6 = $.solr_config('static.ui.highlights');
