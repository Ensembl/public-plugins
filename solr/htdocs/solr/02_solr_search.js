...
(function() {
  var Hub, Renderer, Request, RequestDispatch, SearchTableState, Sensible, Source, code_select, ddg_codes, double_trap, obj_to_str, remote_log, ucfirst, xhr_idx, _a, _ajax_json, _clone_array, _clone_object, _div, _is_prefix_of, _kv_copy, _span,
  ...
  RequestDispatch = (function() {
    ...
    RequestDispatch.prototype.completion_fn = function(values) {
      ...
      offset = this.start;
      num = this.rows;
      this.completion = new window.DeferredHash(this, this.completion_fn);
