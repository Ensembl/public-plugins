...
(function() {
  var Hub, Renderer, Request, SearchTableState, Source, code_select, dispatch_all_requests, dispatch_facet_request, dispatch_main_requests, double_trap, each_block, generate_block_list, main_currency, obj_to_str, rate_limiter, remote_log, xhr_idx, _clone_array, _clone_object, _is_prefix_of, _kv_copy,
  ...
  Request = (function() {
    ...
    Request.prototype.get = function(filter, cols, order, start, rows, next, force) {
      var current_filter,
        _this = this;
      if (force) {
        return this.real_get(filter, cols, order, start, rows).done(function(data) {
          return next(data);
        });
      } else {
        ...
        return rate_limiter({
          ...
          return _this.real_get(filter, cols, order, start, rows).then(current_filter).done(function(data) {
            return next(data);
          });
        });
      }
