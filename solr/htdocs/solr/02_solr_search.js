...
(function() {
  var Hub, Renderer, Request, RequestDispatch, SearchTableState, Source, code_select, dispatch_facet_request, dispatch_main_requests, double_trap, each_block, obj_to_str, remote_log, xhr_idx, _clone_array, _clone_object, _is_prefix_of, _kv_copy,
  ...
  RequestDispatch = (function() {
    ...
    RequestDispatch.prototype.get = function(rigid, filter, order) {
      var all_facets, c, facets, fc, fr, k, q, sort, v, _i, _j, _k, _len, _len1, _len2, _ref,
        _this = this;
      ...
      return $.when(dispatch_main_requests(this.request, this.cols, this.extra, this.input, this.start, this.rows), dispatch_facet_request(this.hub, this.request, this.input)).done(function(main, facet) {
        return _this.next.call(_this, {
          num: _this.rows,
          faceter: facet,
          rows: main,
          cols: _this.cols
