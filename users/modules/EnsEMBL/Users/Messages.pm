...
my %MESSAGES = (
  ...
  MESSAGE_ACCOUNT_PENDING       => sub { 'Your account has not yet been activated. Please contact the helpdesk if you require a new authentication code.' },
  MESSAGE_ACCOUNT_BLOCKED       => sub { 'Your account seems to be blocked. Please contact the helpdesk if you require  help.' },
  MESSAGE_ACCOUNT_DISABLED      => sub { 'Your account seems to be disabled. Please contact the helpdesk if you require help.' },
