package EnsEMBL::WebAdmin::Controller::Command::Web::OldGlossary;

use strict;
use warnings;

use Class::Std;
use EnsEMBL::Web::Object::Data::OldGlossary;
...
sub render_page {
  ...
  my $data = EnsEMBL::Web::Object::Data::OldGlossary->new();
  $interface->data($data);
  $interface->discover;
...
## Form elements
  $interface->element_order('word', 'acronym', 'meaning', 'status');
