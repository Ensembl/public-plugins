...
#-------------------- mammals
  ...
  $SiteDefs::__species_aliases{ 'Mus_musculus_129s1svimj'           } = [qw(mm_129s1svimj mouse_129s1svimj)];
  $SiteDefs::__species_aliases{ 'Mus_musculus_aj'                   } = [qw(mm_aj         mouse_aj)];
  $SiteDefs::__species_aliases{ 'Mus_musculus_akrj'                 } = [qw(mm_akrj       mouse_akrj)];
  $SiteDefs::__species_aliases{ 'Mus_musculus_balbcj'               } = [qw(mm_balbcj     mouse_balbcj)];
  $SiteDefs::__species_aliases{ 'Mus_musculus_c3hhej'               } = [qw(mm_c3hhej     mouse_c3hhej)];
  $SiteDefs::__species_aliases{ 'Mus_musculus_c57bl6nj'             } = [qw(mm_c57bl6nj   mouse_c57bl6nj)];
  $SiteDefs::__species_aliases{ 'Mus_musculus_casteij'              } = [qw(mm_casteij    mouse_casteij)];
  $SiteDefs::__species_aliases{ 'Mus_musculus_cbaj'                 } = [qw(mm_cbaj       mouse_cbaj)];
