...
#-------------------- mammals
  ...
  $SiteDefs::__species_aliases{ 'Cavia_aperea'                      } = [qw(ca brazilian_guineapig)];
  ...
  $SiteDefs::__species_aliases{ 'Fukomys_damarensis'                } = [qw(fd damara_molerat)];
  $SiteDefs::__species_aliases{ 'Gorilla_gorilla'                   } = [qw(gg ggo ggor kong gorilla)]; 
  $SiteDefs::__species_aliases{ 'Heterocephalus_glaber'             } = [qw(hg naked_molerat)];
  $SiteDefs::__species_aliases{ 'Heterocephalus_glaber_female'      } = [qw(hgf female_naked_molerat)];
  ...
  $SiteDefs::__species_aliases{ 'Jaculus_jaculus'                   } = [qw(jj jerboa)];
  ...
  $SiteDefs::__species_aliases{ 'Octodon_degus'                     } = [qw(od degu)];
  ...
  $SiteDefs::__species_aliases{ 'Mesocricetus_auratus'              } = [qw(ma golden_hamster)];
  $SiteDefs::__species_aliases{ 'Microcebus_murinus'                } = [qw(mmur lemur)];
  $SiteDefs::__species_aliases{ 'Microtus_ochrogaster'              } = [qw(mo prairie_vole)];
  ...
  $SiteDefs::__species_aliases{ 'Nannospalax_galili'                } = [qw(ng blind_molerat)];
  ...
  $SiteDefs::__species_aliases{ 'Peromyscus_maniculatus'            } = [qw(pm deermouse)];
