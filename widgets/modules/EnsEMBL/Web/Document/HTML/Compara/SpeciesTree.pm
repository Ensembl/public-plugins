...
sub render {
  ...
  my $ncbi_mammal_node            = $ncbi_species_tree->find_node_by_name("Mammalia");
  $tree_details->{'ncbi_mammals'} = $ncbi_mammal_node->newick_format('ryo', $format);

  my $ncbi_sauria_node            = $ncbi_species_tree->find_node_by_name("Sauria");
  $tree_details->{'ncbi_sauria'}  = $ncbi_sauria_node->newick_format('ryo', $format);

  my $ncbi_amniota_node           = $ncbi_species_tree->find_node_by_name("Amniota");
  $tree_details->{'ncbi_amniota'} = $ncbi_amniota_node->newick_format('ryo', $format);

  my $ncbi_fish_node              = $ncbi_species_tree->find_node_by_name("Neopterygii");
  $tree_details->{'ncbi_fish'}    = $ncbi_fish_node->newick_format('ryo', $format);
...
# warn "Ensembl (Binary) Fish tree:\n"; warn $ensembl_fish_node->newick_format('ryo', $format), "\n\n\n";
  ...
  $tree_details->{'newick_mammals'} = "((((((Loxodonta africana:1,Procavia capensis:1)Afrotheria:1,Echinops telfairi:1)Afrotheria:1,(Choloepus hoffmanni:1,Dasypus novemcinctus:1)Xenarthra:1)Eutheria:1,(((Sorex araneus:1,Erinaceus europaeus:1)Insectivora:1,(((((Bos taurus:1,Ovis aries:1)Bovidae:1,Tursiops truncatus:1)Cetartiodactyla:1,Vicugna pacos:1)Cetartiodactyla:1,Sus scrofa:1)Cetartiodactyla:1,(((((Mustela putorius furo:1,Ailuropoda melanoleuca:1)Caniformia:1,Canis lupus familiaris:1)Caniformia:1,Felis catus:1)Carnivora:1,Equus caballus:1)Laurasiatheria:1,(Pteropus vampyrus:1,Myotis lucifugus:1)Chiroptera:1)Laurasiatheria:1)Laurasiatheria:1)Laurasiatheria:1,((((((Mus musculus:1,Rattus norvegicus:1)Murinae:1,Dipodomys ordii:1)Sciurognathi:1,Ictidomys tridecemlineatus:1)Sciurognathi:1,Cavia porcellus:1)Rodentia:1,(Ochotona princeps:1,Oryctolagus cuniculus:1)Lagomorpha:1)Glires:1,(((Otolemur garnettii:1,Microcebus murinus:1)Strepsirrhini:1,(((((((Pan troglodytes:1,Homo sapiens:1)Homininae:1,Gorilla gorilla gorilla:1)Homininae:1,Pongo abelii:1)Hominidae:1,Nomascus leucogenys:1)Hominoidea:1,((Papio anubis:1,Macaca mulatta:1)Cercopithecinae:1,Chlorocebus sabaeus:1)Cercopithecinae:1)Catarrhini:1,Callithrix jacchus:1)Simiiformes:1,Tarsius syrichta:1)Haplorrhini:1)Primates:1,Tupaia belangeri:1)Euarchontoglires:1)Euarchontoglires:1)Boreoeutheria:1)Eutheria:1,((Macropus eugenii:1,Sarcophilus harrisii:1)Marsupialia:1,Monodelphis domestica:1)Marsupialia:1)Theria:1,Ornithorhynchus anatinus:1)Mammalia:1;";
  
  $tree_details->{'newick_sauria'} = "((((Taeniopygia guttata:1,Ficedula albicollis:1)Passeriformes:1,((Gallus gallus:1,Meleagris gallopavo:1)Phasianidae:1,Anas platyrhynchos:1)Galloanserae:1)Neognathae:1,Pelodiscus sinensis:1)Testudines + Archosauria group:1,Anolis carolinensis:1)Sauria:1;";
  
  $tree_details->{'newick_amniota'} = "(((((((Loxodonta africana:1,Procavia capensis:1)Afrotheria:1,Echinops telfairi:1)Afrotheria:1,(Choloepus hoffmanni:1,Dasypus novemcinctus:1)Xenarthra:1)Eutheria:1,(((Sorex araneus:1,Erinaceus europaeus:1)Insectivora:1,(((((Bos taurus:1,Ovis aries:1)Bovidae:1,Tursiops truncatus:1)Cetartiodactyla:1,Vicugna pacos:1)Cetartiodactyla:1,Sus scrofa:1)Cetartiodactyla:1,(((((Mustela putorius furo:1,Ailuropoda melanoleuca:1)Caniformia:1,Canis lupus familiaris:1)Caniformia:1,Felis catus:1)Carnivora:1,Equus caballus:1)Laurasiatheria:1,(Pteropus vampyrus:1,Myotis lucifugus:1)Chiroptera:1)Laurasiatheria:1)Laurasiatheria:1)Laurasiatheria:1,((((((Mus musculus:1,Rattus norvegicus:1)Murinae:1,Dipodomys ordii:1)Sciurognathi:1,Ictidomys tridecemlineatus:1)Sciurognathi:1,Cavia porcellus:1)Rodentia:1,(Ochotona princeps:1,Oryctolagus cuniculus:1)Lagomorpha:1)Glires:1,(((Otolemur garnettii:1,Microcebus murinus:1)Strepsirrhini:1,(((((((Pan troglodytes:1,Homo sapiens:1)Homininae:1,Gorilla gorilla gorilla:1)Homininae:1,Pongo abelii:1)Hominidae:1,Nomascus leucogenys:1)Hominoidea:1,((Papio anubis:1,Macaca mulatta:1)Cercopithecinae:1,Chlorocebus sabaeus:1)Cercopithecinae:1)Catarrhini:1,Callithrix jacchus:1)Simiiformes:1,Tarsius syrichta:1)Haplorrhini:1)Primates:1,Tupaia belangeri:1)Euarchontoglires:1)Euarchontoglires:1)Boreoeutheria:1)Eutheria:1,((Macropus eugenii:1,Sarcophilus harrisii:1)Marsupialia:1,Monodelphis domestica:1)Marsupialia:1)Theria:1,Ornithorhynchus anatinus:1)Mammalia:1,((((Taeniopygia guttata:1,Ficedula albicollis:1)Passeriformes:1,((Gallus gallus:1,Meleagris gallopavo:1)Phasianidae:1,Anas platyrhynchos:1)Galloanserae:1)Neognathae:1,Pelodiscus sinensis:1)Testudines + Archosauria group:1,Anolis carolinensis:1)Sauria:1)Amniota:1;";
  
  $tree_details->{'newick_fish'} = "(((((Tetraodon nigroviridis:1,Takifugu rubripes:1)Tetraodontidae:1,((((Xiphophorus maculatus:1,Poecilia formosa:1)Poeciliinae:1,Oryzias latipes:1)Atherinomorphae:1,Gasterosteus aculeatus:1)Percomorphaceae:1,Oreochromis niloticus:1)Percomorphaceae:1)Percomorphaceae:1,Gadus morhua:1)Acanthomorphata:1,(Danio rerio:1,Astyanax mexicanus:1)Otophysa:1)Clupeocephala:1,Lepisosteus oculatus:1)Neopterygii:1;";
    ...
    <script>  
      if(!document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Shape", "1.1")) {
        ...
        window.onload = function() {
          ...
          var theme = tnt_theme_tree_simple_species_tree($json_info);
