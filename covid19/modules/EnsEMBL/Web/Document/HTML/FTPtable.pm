...
sub render {
  ...
  #   emf       => qq(<a rel="external" title="$title{'emf'}" href="$ftp_base_url/$rel/emf/ensembl-compara/">EMF</a>),
  #   maf       => qq(<a rel="external" title="$title{'maf'}" href="$ftp_base_url/$rel/maf/ensembl-compara/">MAF</a>),
  #   bed       => qq(<a rel="external" title="$title{'bed'}" href="$ftp_base_url/$rel/bed/">BED</a>),
